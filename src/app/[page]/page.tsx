...
const pages: Record<string, {
    ...
    shipping: { title: 'Shipping & delivery.', intro: 'Cash on delivery across Pakistan, with delivery charges shown before you place your order.', sections: [['Delivery charges', 'The configured starting fee is Rs. 250, with free delivery on orders of Rs. 20,000 or more. Your final delivery charge is calculated at checkout for your city.'], ['Order confirmation', 'Orders are pending until our team confirms them. Delivery estimates and courier coverage will be confirmed with you.'], ['Receiving your order', 'Please provide a complete address and an active Pakistani mobile number. Keep your payment ready when the courier arrives.']] },
